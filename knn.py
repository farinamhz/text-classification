...
clf1 = KNeighborsClassifier(n_neighbors=1).fit(X_train_tfidf, train_data['class'])
clf2 = KNeighborsClassifier(n_neighbors=5).fit(X_train_tfidf, train_data['class'])
clf3 = KNeighborsClassifier(n_neighbors=15).fit(X_train_tfidf, train_data['class'])
